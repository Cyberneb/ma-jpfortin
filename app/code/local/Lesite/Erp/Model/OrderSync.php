...
print_r(get_object_vars($order));
    ...
    public function updateAll()
    {
        ...
        $last_accessed = Mage::getResourceModel('lesite_erp/orderSync')->getLastAccessed();
        ...
        $daily_update = Mage::getResourceModel('lesite_erp/orderSync')->getDailyUpdate();
        ...
        {
            Mage::getResourceModel('lesite_erp/orderSync')->getNewProducts();
        }
        
        $product_data = Mage::getResourceModel('lesite_erp/orderSync')->addNewProduct();
