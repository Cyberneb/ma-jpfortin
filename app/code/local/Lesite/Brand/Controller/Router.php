...
class Lesite_Brand_Controller_Router extends Mage_Core_Controller_Varien_Router_Standard//Mage_Core_Controller_Varien_Router_Abstract
{
	/**
	...
	*/
	public function initControllerRouters($observer)
	{
		...
		$front->addRouter('lesite_brand', $this);
	}
	...
	*/
	public function match(Zend_Controller_Request_Http $request)
	{
        ...
        $routerConfig = 'brand';
        $_end = Mage::getStoreConfig(Lesite_Brand_Helper_Data::XML_FRONTEND_LINK);
        ...
        if (isset($_link_params[0])){
            ...
            if($router == $routerConfig){
                $request->setRouteName('lesite_brand')
                        ->setControllerModule('Lesite_Brand')
                        ->setModuleName('brand')
                        ;
                $module = 'lesite_brand';
                ...
                $controllerClassName = $this->_validateControllerClassName('Lesite_Brand', $controller);
